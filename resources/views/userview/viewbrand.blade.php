        ...
        <div class="row">
                    ...
                    <div class="tab-content jump">
                        ...
                        <div id="shop-1" class="tab-pane active">
                            <div class="row responsive-md-class responsive-xl-class responsive-lg-class">
                            	<?php
										foreach ($productByBrands as $v_probybra) {
								?>
                                <div class="col-xl-3 col-md-4 col-sm-6 ">
                                    <article class="list-product">
                                        <div class="img-block">
                                            <a href="single-product.html" class="thumbnail">
                                                <img class="first-img" src="{{URL::to($v_probybra->cover_photo)}}" alt="" />
                                            </a>
                                        ...
                                        <div class="product-decs">
                                            <a class="inner-link" href="shop-4-column.html"><span>{{$v_probybra->title}}</span></a>
                                            ...
                                            <div class="pricing-meta">
                                                <ul>
                                                    <li class="old-price not-cut">{{$v_probybra->sell_price}} BDT</li>
                                                </ul>
                                            </div>
                                        </div>
                                            <ul>
            ...
            <div class="col-lg-3 order-lg-first col-md-12 order-md-last mb-md-60px mb-lm-60px">
                <div class="shop-sidebar-wrap">
                	<?php foreach ($productByBrands as $v_probybra) {
                		$bra_id=$v_probybra->brand_id;
                	}
                	
                		$all_bra_info=DB::table('tbl_category')
                						->where('id',$bra_id)
                						->get();
                		foreach ($all_bra_info as $v_bra) {
                	?>

                    <div class="sidebar-widget padding-30px bg-light-gray-2 mb-30px">

                        <h3 class="sidebar-title">{{$v_bra->parent_id}}</h3>
                        <div class="accordion" id="accordionExample">
                            <div class="card">
                            	<?php
                            		$all_info=DB::table('tbl_category')
                            				->get();
                            		foreach ($all_info as $v_sub_bra) {
                            			if($v_sub_bra->parent_id==$v_bra->parent_id){
                            	?>
                            	<div class="card-body">
                                    <ul class="category-list">
        	                            <li><a href="#">{{$v_sub_bra->name}}</a></li>
									</ul>
                                </div>                   
                            <?php }} ?>
                            </div> <!-- card -->
                    ...
                    <div class="sidebar-widget-group mt-20 padding-30px">
                        ...
                        <div class="sidebar-widget mt-30">
                            ...
                            <div class="sidebar-widget-list">
                            	<?php foreach ($productByBrands as $v_productByBrand) {
		                		$bra_id=$v_productByBrand->brand_id;
		                	}
